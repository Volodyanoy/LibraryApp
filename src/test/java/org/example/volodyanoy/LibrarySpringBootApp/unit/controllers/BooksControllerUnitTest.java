...
import org.example.volodyanoy.LibrarySpringBootApp.controllers.BooksController;
...
@Import(BooksControllerUnitTestConfig.class)
...
public class BooksControllerUnitTest {
    ...
    @Autowired
    public BooksControllerUnitTest(MockMvc mockMvc, BooksService booksService) {
